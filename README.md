# pagila-hw
[![](https://github.com/abooli/pagila-hw/workflows/tests/badge.svg)](https://github.com/abooli/pagila-hw/actions?query=workflow%3Atests)
...
1. Fork this repo and clone it on the lambda server.
   ...
   ```
   $ git clone https://github.com/abooli/pagila-hw
   $ cd pagila-hw
   $ git submodule init
